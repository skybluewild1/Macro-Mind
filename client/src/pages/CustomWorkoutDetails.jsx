...
export default function CustomWorkoutDetails() {
  ...
  useEffect(() => {
    if (user) {
      axios
        .get(`/api/customWorkouts/${userId}/${workoutId}`)
        ...
        {editing ? (
          <>
            ...
            <div className="button-row">
              <button
                ...
                onClick={() => setShowBrowseExercises(!showBrowseExercises)}
              >
              ...
              <button
                className="browse-btn"
                onClick={() =>
                  setShowCustomExerciseForm(!showCustomExerciseForm)
                }
              >
              ...
              <div className="exercise-list">
                {exercises.map((ex) => (
                  <div
                    ...
                    onClick={() => handleAddExerciseFromBrowse(ex)}
                  >
          ...
          <>
            ...
            <div className="button-row">
              ...
              <button className="remove-btn" onClick={handleRemoveWorkout}>
                Remove Workout
              </button>
            </div>
          </>
