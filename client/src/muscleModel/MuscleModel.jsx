...
const MuscleModel = () => {
  ...
  const muscles = convertToPercentages([
    ...
    { name: "Left Delts", x: 154, y: 183, width: 17, height: 47, side:"front", group: "Frontdelt", description: "The front deltoid raises the arm forward and to the side, helping with pressing and lifting motions."  },
    { name: "Right Delts", x: 298, y: 183, width: 17, height: 47, side:"front", group: "Frontdelt", description: "The front deltoid raises the arm forward and to the side, helping with pressing and lifting motions."  },
    { name: "Left Pectorial", x: 171, y: 179, width: 65, height: 65, side:"front", group: "Chest", description: "The pectoral muscle moves the arms across the chest and helps with pushing movements."  },
    { name: "Right Pectorial", x: 233, y: 179, width: 65, height: 65, side:"front", group: "Chest", description: "The pectoral muscle moves the arms across the chest and helps with pushing movements."  },
    { name: "Abdominal", x: 190, y: 267, width: 90, height: 80, side:"front", group: "abs", description: "The abdominal muscles flex the torso, stabilize the core, and support breathing and posture."  },
    ...
    { name: "Left Quadricep", x: 187, y: 365, width: 35, height: 130, side:"front", group: "Quadricep", description: "The quadricep extends the knee and is important for walking, squatting, and jumping."  },
    { name: "Right Quadricep", x: 247, y: 365, width: 35, height: 130, side:"front", group: "Quadricep", description: "The quadricep extends the knee and is important for walking, squatting, and jumping."  },
    ...
    { name: "Front Left Calf", x: 193, y: 535, width: 32, height: 50, side:"front", group: "Calf", description: "The calf muscle helps raise the heel and is essential for walking, running, and jumping."  },
    { name: "Front Right Calf", x: 245, y: 535, width: 32, height: 50, side:"front", group: "Calf", description: "The calf muscle helps raise the heel and is essential for walking, running, and jumping."  },
    //back body muscles 
    ...
    { name: "Left Rear Delts", x: 433, y: 183, width: 17, height: 47, side:"back", group: "Reardelt", description: "The rear deltoid moves the arm backward and outward, supporting posture and pulling motions."  },
    { name: "Right Rear Delts", x: 577, y: 183, width: 17, height: 47, side:"back", group: "Reardelt", description: "The rear deltoid moves the arm backward and outward, supporting posture and pulling motions."  },
    ...
    { name: "Left Glute", x: 462, y: 344, width: 52, height: 59, side:"back", group: "Glute", description: "The glute extends and rotates the hip and provides power for walking, climbing, and lifting."  },
    { name: "Right Glute", x: 514, y: 344, width: 51, height: 59, side:"back", group: "Glute", description: "The glute extends and rotates the hip and provides power for walking, climbing, and lifting."  },
    ...
    { name: "Left Hamstring", x: 465, y: 402, width: 35, height: 100, side:"back", group: "Hamstring", description: "The hamstring bends the knee and extends the hip, crucial for running and jumping."  },
    { name: "Right Hamstring", x: 526, y: 402, width: 35, height: 100, side:"back", group: "Hamstring", description: "The hamstring bends the knee and extends the hip, crucial for running and jumping."  },
    { name: "Back Left Calf", x: 472, y: 535, width: 30, height: 50, side:"back", group: "Calf", description: "The calf muscle helps raise the heel and is essential for walking, running, and jumping."  },
    { name: "Back Right Calf", x: 525, y: 535, width: 30, height: 50, side:"back", group: "Calf", description: "The calf muscle helps raise the heel and is essential for walking, running, and jumping." }
  ]);
